(() => {
    ...
    function c() {
      ...
      if (
        ("fraction" === s.type &&
          ...
          r.find(oe(s.totalClass)).text(s.formatFractionTotal(p))),
        "progressbar" === s.type)
      ) {
        let e;
    ...
    ce(),
      document.querySelector(".main__slider") &&
        new re(".main__slider", {
          ...
          parallax: !0,
          preloadImages: !0,
          pagination: { el: ".slider-main__bullets", clickable: !0 },
          navigation: {
      ...
      document.querySelector(".rooms__slider ") &&
        new re(".rooms__slider", {
          ...
          parallax: !0,
          preloadImages: !0,
          pagination: { el: ".slider-rooms__bullets", clickable: !0 },
          navigation: {
      ...
      document.querySelector(".tips__slider") &&
        new re(".tips__slider", {
          ...
          parallax: !0,
          preloadImages: !0,
          pagination: { el: ".slider-tips__bullets", clickable: !0 },
          navigation: {
  ...
  setTimeout(() => {
    ...
    window.addEventListener("load", (e) => {
      const t = document.querySelector(".actions-header__link_search"),
        s = document.querySelector(".form-menu"),
        i = document.querySelectorAll(".menu__button");
      i.forEach((e) => {
        e.addEventListener("click", (t) => {
          if (window.innerWidth < 993)
            document.querySelector(".menu__sub-list._slide")
              ? e.setAttribute("disabled")
              : e.removeAttribute("disabled"),
              e.parentElement.classList.toggle("_active");
          else {
            const t = e.parentElement,
              s = document.querySelector(".menu__item._active");
            s && t !== s && s.classList.remove("_active"),
              e.parentElement.classList.toggle("_active");
          }
        });
      }),
        ...
        window.addEventListener("click", (e) => {
          const t = e.target;
          document.querySelector(".form-menu._active") &&
            (t.closest(".actions-header__link_search") ||
              t.closest(".form-menu") ||
              s.classList.remove("_active")),
            document.querySelector(".menu__item._active") &&
              (t.closest(".menu__item") ||
                i.forEach((e) => {
                  e.parentElement.classList.remove("_active");
                }));
        });
      const n = document.querySelector(".gallery__items");
      if (n.offsetWidth > window.innerWidth) {
        let e = 0,
          t = null;
        n.addEventListener("mousemove", (s) => {
          let i = s.pageX;
          t &&
            (i < t && e <= n.offsetWidth / 3
              ? ((e += 2.5), (n.style.transform = `translate3d(${e}px, 0, 0)`))
              : i > t &&
                -e <= n.offsetWidth / 3 &&
                ((e -= 2.5),
                (n.style.transform = `translate3d(${e}px, 0, 0)`))),
            (t = i);
        });
      }
    }),
